      ...
      <section className="relative py-24 bg-transparent animate-on-scroll opacity-0 translate-y-12 transition-all duration-1000">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-16 text-center">
            <h2 className="text-6xl md:text-7xl font-display text-white mb-4">SHOP BY STYLE</h2>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-16 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            <div>
              ...
              <h2 className="text-6xl md:text-7xl font-display text-white">FRESH DROPS</h2>
            </div>
            <Link
              to="/category/new-arrivals"
              className="group inline-flex items-center gap-3 text-white font-grotesk font-bold text-lg border-b-2 border-white/70 pb-2 hover:border-accent-electric hover:text-accent-electric transition-all"
            >
              VIEW ALL
              <FiArrowRight className="group-hover:translate-x-2 transition-transform" size={24} />
            </Link>
          ...
          <div className="rounded-3xl border border-white/15 bg-slate-900/35 backdrop-blur-sm p-4 md:p-6">
